...
@pytest.mark.parametrize(
    "a, b, expected",
    [
        (8, 3, 11),           # Test adding two positive integers
        (-5, -1, -6),        # Test adding two negative integers
        (3.5, 8.5, 12.0),     # Test adding two positive floats
        (-7.5, 9.5, 2.0),    # Test adding a negative float and a positive float
...
@pytest.mark.parametrize(
    "a, b, expected",
    [
        (20, 4, 16),           # Test subtracting a smaller positive integer from a larger one
        (-18, -5, -13),        # Test subtracting a negative integer from another negative integer
        (8.5, 3.5, 5.0),     # Test subtracting two positive floats
        (-7.5, -1.5, -6.0),  # Test subtracting two negative floats
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (-2, 8, -16),         # Test multiplying a negative integer with a positive integer
        (2.5, 8.0, 20.0),    # Test multiplying two positive floats
        (-2.5, 20.0, -50.0),  # Test multiplying a negative float with a positive float
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (-15, 3, -5.0),         # Test dividing a negative integer by a positive integer
        (12.0, 3.0, 4.0),       # Test dividing two positive floats
        (-12.0, 3.0, -4.0),     # Test dividing a negative float by a positive float
        (0, 1, 0.0),            # Test dividing zero by a positive integer
    ],
    ids=[
